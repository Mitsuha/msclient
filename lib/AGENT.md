...
## Project Context
* **Desktop App:** This is a desktop application project.
* **macOS Design:** Design and implement UI with a macOS-native style. Prefer desktop-first layouts, macOS interaction patterns, platform-appropriate spacing, typography, controls, window behavior, and visual hierarchy.
...
* **Desktop-First:** Treat macOS desktop as the primary target. Avoid mobile-first layouts unless explicitly requested.
* **macOS Style:** Use macOS-inspired UI patterns: restrained surfaces, clear sidebars/toolbars, native-feeling controls, balanced whitespace, subtle borders, and platform-consistent hover, focus, and keyboard states.
